...
learning_rate = 0.05; % 0.02, 0.04, 0.06, 0.08, 0.1, 0.12
...
% fname1=sprintf('realwordldata__db1_proposed_increasing_%dchs_LR_%d_h%d.fig',sensors_num,learning_rate,threshold_h);
fname1=sprintf('realwordldata_db1_proposed_increasing.fig');
